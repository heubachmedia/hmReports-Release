extern Txt K;
extern unsigned char D_proc_INTERN__GETVSTRUCPROPERTYTEXT[];
void proc_INTERN__GETVSTRUCPROPERTYTEXT( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_proc_INTERN__GETVSTRUCPROPERTYTEXT);
