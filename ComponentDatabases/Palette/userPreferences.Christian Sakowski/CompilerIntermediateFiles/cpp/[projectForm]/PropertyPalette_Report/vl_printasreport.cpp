...
extern unsigned char D_obj_p_PropertyPalette__Report_00vl__printasreport[];
void obj_p_PropertyPalette__Report_00vl__printasreport( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_obj_p_PropertyPalette__Report_00vl__printasreport);
