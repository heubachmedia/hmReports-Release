...
extern unsigned char D_obj_p_PropertyPalette__Report_00vz__rep__breite[];
void obj_p_PropertyPalette__Report_00vz__rep__breite( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_obj_p_PropertyPalette__Report_00vz__rep__breite);
