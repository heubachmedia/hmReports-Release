...
extern unsigned char D_obj_p_hmReports__Palette_00subform__report__properties[];
void obj_p_hmReports__Palette_00subform__report__properties( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_obj_p_hmReports__Palette_00subform__report__properties);
