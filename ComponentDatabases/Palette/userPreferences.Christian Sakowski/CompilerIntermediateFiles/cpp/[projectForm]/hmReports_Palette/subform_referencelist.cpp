...
extern unsigned char D_obj_p_hmReports__Palette_00subform__referencelist[];
void obj_p_hmReports__Palette_00subform__referencelist( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_obj_p_hmReports__Palette_00subform__referencelist);
