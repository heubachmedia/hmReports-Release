extern Txt K;
extern unsigned char D_proc_PARSE__GETREPORTPROPERTYTEXT[];
void proc_PARSE__GETREPORTPROPERTYTEXT( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_proc_PARSE__GETREPORTPROPERTYTEXT);
